...
private:
    ...
    sat_n::Lit l_out1; // output literal of dbl.
    sat_n::Lit l_out2; // output literal of dbl.
    //mark
    std::vector<sat_n::Lit> keyinput_literals_A, keyinput_literals_B, keyinput_literals_C, keyinput_literals_D;
    std::vector<sat_n::Lit> cktinput_literals;
    std::vector<sat_n::Lit> output_literals_A, output_literals_B, output_literals_C, output_literals_D;
