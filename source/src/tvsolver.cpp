...
bool tv_solver_t::isNonMutable(int i, int j, int k, int l)
{
    using namespace ckt_n;
    using namespace sat_n;
    ...
    node_t* kk = ckt.key_inputs[k];
    node_t* kl = ckt.key_inputs[l];

    dup_twoKeys_t dup(ki, kj, kk, kl);
    ...
    node_t* kkC = dbl.getC(kk);
    node_t* kkD = dbl.getD(kk);
    node_t* klC = dbl.getC(kl);
    node_t* klD = dbl.getD(kl);
    ...
    _set_node_value(dbl, lit_map, kkC, 0, assumps);
    _set_node_value(dbl, lit_map, kkD, 1, assumps);
    _set_node_value(dbl, lit_map, klC, 2, assumps);
    _set_node_value(dbl, lit_map, klD, 2, assumps);
    ...
    _set_node_value(dbl, lit_map, kkC, 2, assumps);
    _set_node_value(dbl, lit_map, kkD, 2, assumps);
    _set_node_value(dbl, lit_map, klC, 0, assumps);
    _set_node_value(dbl, lit_map, klD, 1, assumps);
