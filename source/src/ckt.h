...
namespace ckt_n {
    ...
    struct ckt_t
    {
        ...
        ckt_t(nodepair_list_t& pair_map, nodepair_list_t& pair_map1);           // circuit 4 times constructor.
        ckt_t(const ckt_t& c1, const ckt_t& c2);    // circuit comparison constructor.
        //ckt_t(const ckt_t& c1, const ckt_t& c2, const ckt_t& c3, const ckt_t& c4);    // circuit comparison constructor.
    ...
    private:
        ...
        //void _create_ckt_inputs(node_map_t& n, const nodelist_t& i1, const nodelist_t& i2, const nodelist_t& i3, const nodelist_t& i4);
        ...
        //compare keys
        void _compare_keys(node_map_t& nm, const nodelist_t& i1, const nodelist_t& i2);
